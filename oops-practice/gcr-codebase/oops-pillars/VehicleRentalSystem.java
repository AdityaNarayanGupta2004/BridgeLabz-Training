...
abstract class Vehicle {
    ...
    // Applying the concept of Encapsulation (Getter and Setter)
    ...
    // Adding a Abstract Method
    public abstract double calculateRentalCost(int days);
}
// making a interface name-> Insurable
interface Insurable {
    double calculateInsurance();
    String getInsuranceDetails();
}
// Applying inheritance and interface concept
// for interface using implements AND for inheritance using extends
class Car extends Vehicle implements Insurable {
    ...
    // Applying concept of polymorphism (Overiding)
    @Override
...
public class VehicleRentalSystem {
    ...
    public static void main(String[] args) {
        ...
        vehicles.add(new Car("1234", 2000, "POLICY-C1"));
